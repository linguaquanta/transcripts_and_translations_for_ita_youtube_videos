...
print(funcs.clean_filename(video_title))
...
if transcript:
	...
	script_strs = [it_script_str, en_script_str]
	...
	# string and needs to be processed differently than above
		...
		# print(segmenter.segment(it_script_str))
		# it_script_str = segmenter.segment(it_script_str)
		# en_script_str = en_segmenter.segment(en_script_str)
